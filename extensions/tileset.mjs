...
export class Tile {
	constructor(json, resourcePath, styleParams, updateCallback, parentRefine, parentTransform) {
		...
		if (this.transform) {
			...
			//tileMatrix.setPosition(55.5,37.2,1);
			tileMatrix.elements[12]=-55.5;
			tileMatrix.elements[13]=-37.2;
			tileMatrix.elements[14]=-2.1;
			tileMatrix.scale(new THREE.Vector3(3.38,3.38,3.38));
			//tileMatrix.setPosition(0,0,0);
			//alert('setes')
